    ...
    <CompanyDetailClient
      company={{
        ...
        contacts: company.contacts
          .filter((contact: { id: string; firstName: string | null; lastName: string | null; email: string | null; position: string | null }) => 
            contact.firstName !== null && contact.lastName !== null
          )
          .map((contact: { id: string; firstName: string | null; lastName: string | null; email: string | null; position: string | null }) => ({
            id: contact.id,
